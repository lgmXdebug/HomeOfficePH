...
const posts = [
  ...
  { slug: 'top-mechanical-keyboards-under-3000-philippines', tag: 'Keyboard', tagColor: '#8F6BC9', title: 'Top Mechanical Keyboards Under ₱3,000', excerpt: 'Satisfying to type on, easy on the wallet. These are the best budget mechs available in the Philippines.', readTime: '7 min read', emoji: '⌨️', date: 'July 3, 2026' },
  { slug: 'desk-organization-ideas-small-home-offices-philippines', tag: 'Storage', tagColor: '#4CC9A8', title: 'Desk Organization Ideas for Small Home Offices', excerpt: 'Maximize your desk space with these clever storage and organization solutions tested in real Filipino homes.', readTime: '6 min read', emoji: '📦', date: 'July 3, 2026' },
  { slug: 'best-noise-cancelling-headphones-wfh-philippines', tag: 'Headphones', tagColor: '#6B8F71', title: 'Best Noise-Cancelling Headphones for WFH Philippines', excerpt: 'Block out distractions and focus. We ranked the best noise-cancelling headphones from ₱1,500 to ₱20,000.', readTime: '9 min read', emoji: '🎧', date: 'July 3, 2026' },
]
