...
const posts = [
  ...
  { slug: '#', tag: 'Keyboard', tagColor: '#8F6BC9', title: 'Top Mechanical Keyboards Under ₱3,000', excerpt: 'Satisfying to type on, easy on the wallet.', readTime: '7 min read', emoji: '⌨️', date: 'June 5, 2026' },
  { slug: '#', tag: 'Storage', tagColor: '#4CC9A8', title: 'Desk Organization Ideas for Small Home Offices', excerpt: 'Maximize your desk space with these clever storage solutions.', readTime: '6 min read', emoji: '📦', date: 'May 20, 2026' },
  { slug: '#', tag: 'Headphones', tagColor: '#6B8F71', title: 'Best Noise-Cancelling Headphones for WFH', excerpt: 'Block out distractions and focus.', readTime: '9 min read', emoji: '🎧', date: 'May 14, 2026' },
]
